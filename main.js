...
function initMap(){
    ...
    let weather = {
        ...
        displayWeather: function (data) {
            ...
            let protectedBeaches = "By the direction of the wind, the beaches that are more protected are:";
            ...
            const contentText = [
                '<h4>Bar Beach</h4>' + "<p>Swimming, fishing, surfing, snorkeling, whale watching up on the headland, viewing platforms, 20m from carpark.<br><br>Toilets, shade, walking tracks up through the headland,  BBQ's, picnic facilities . A good choice for young children.</p>",
                '<h4>Main Beach</h4>' + "<p>Swimming, fishing, surfing, snorkeling, whale watching, viewing platforms, 20m from carpark.  Toilets, shade, beach walking,  BBQ's, picnic facilities, large adventure playground, sports oval.<br><br>Patrolled during holidays, a good choice for young children.  Off leash dog friendly in certain areas.</p>",
                '<h4>Mitchies Jetty</h4>' + "<p>Mitchies Jetty is located on the corner of Fishpen Road and Ocean Drive at a small round-a-bout. There is plenty of parking available. Mitchies Jetty counts with a Espresso Bar Coffee on the beach. It is the great location to launch your Merimbula SUP and kayak hire</p>",
                '<h4>Tura Beach</h4>' + "<p>Surfing, swimming, fishing, whale watching, bushwalking tracks, picnic table, toilets, 200m from carpark, dog friendly.</p>",
                '<h4>Middle Beach</h4>' + "<p>Swimming, fishing, whale watching,  viewing areas, 300m from carpark down a track and of stairs.  Not a good choice for young children with quite a lot of stairs and often dangerous swell conditions.</p>",
                '<h4>Short Point Beach</h4>' + "<p>Surfing, swimming, fishing, whale watching, walking tracks, picnic table, toilets, viewing platform,150m from carpark, patrolled beach during holidays.  Leashed dog friendly except when the beach is patrolled then a 100m distance from the patrolled area is required.</p>",
                '<h4>Dolphin Cove</h4>' + "<p>Surfing, swimming, fishing, whale watching, bushwalking tracks, picnic table, viewing platforms, 400m from carpark, dog friendly.<br><br>Accessible from Dolphin Cove residential area.</p>",
                '<h4>North Tura Beach</h4>' + "<p>Surfing, swimming, fishing, whale watching, bushwalking tracks, picnic table, toilets, 200m from carpark.<br><br>Accessible via Bournda National Park just north of Tura Beach.</p>",
                '<h4>Spencer Park</h4>' + "<p>Swimming, fishing, snorkeling, viewing areas, 50m from carpark or 100m from the street.  Parkland, toilets, shade, walking tracks up through Rotary Park and onto Bar Beach. BBQ's, picnic facilities, playground . A good choice for young children.</p>",
                '<h4>Pambula Beach</h4>' + "<p>Swimming, fishing, surfing, snorkeling, whale watching, viewing platforms, 20m from carpark.<br><br>Toilets, beach walking,  walking tracks over the headland, BBQ's, picnic facilities. Patrolled Beach during holidays, a good choice for young children. </p>",
                '<h4>Lions Park Beach</h4>' + "<p>Swimming, fishing, surfing, snorkeling, whale watching, viewing platforms, 20m from carpark.<br><br>Toilets, shade, beach walking,  playground, walking tracks over the headland, BBQ's, picnic facilities, off-leash dog friendly.</p>",
                '<h4>Pambula Rivermouth</h4>' + "<p>Swimming, fishing, surfing, snorkeling, whale watching, viewing platforms up on the headland, 20m from carpark.<br><br>Toilets, shade, beach walking,  playground, walking tracks over the headland and up the river, picnic facilities.</p>",
                '<h4>Bar Mouth Beach</h4>' + "<p>Swimming, fishing, surfing, snorkeling, whale watching, 200m from carpark with stairs and track.  Shade, beach walking,  bushwalking tracks through the National Park and towards Haycock Point.<br><br>Accessible from Ben Boyd National Park.  Take water & sunscreen.</p>",
                '<h4>Severs Beach</h4>' + "<p>Swimming, fishing, snorkeling, 700m from carpark with walking track.  Take water & sunscreen.<br><br>Accessible from Ben Boyd National Park.</p>",
            ];
